...
class flaskConfig(object):
    def __init__(self):
        ...
        self.every_time_trade_share = 11 # 33 测试环境下要求小数点后面3位精度，买10u的话只要0.000304左右，四舍五入就是0.000了，这样买不上
        self.cut_position_threshold = 0.8 # 0.2为亏损到本金的2成仓的0。8走位时，割肉
        self.quantity = 0.008
        self.leverage = 20
        self.position_side = 'LONG'  # 切换网格的方向，BOTH:多空对冲网格， LONG：做多网格， SHORT：做空网格
        self.long_bottom_position_share = 0.3 #底仓的仓位成数， 0.2代表两成
        ...
        self.end_martin_grid = 3 # 要不设定为三分之一仓位？？
