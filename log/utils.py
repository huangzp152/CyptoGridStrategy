...
class TimeUtils(object):
    ...
    @staticmethod
    def getCurrentOnlyTime():
        return time.strftime(TimeUtils.TimeFormatter, time.localtime(time.time()))
...
if __name__ == '__main__':
    ZipUtils.zip_dir("/Users/look/Desktop/project/mobileperf-turandot/mobileperf/common2/test","test.zip")
