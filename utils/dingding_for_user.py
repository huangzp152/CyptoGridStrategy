...
class Message:
    ...
    def dingding_warn(text):
        ...
        if config.test:
            ...
            api_url_dingding = "https://oapi.dingtalk.com/robot/send?timestamp=%s&access_token=%s" % (str(round(time.time() * 1000)), '7b67bcb13b3fe298eff7537dd9141621a73e3cb5f8d2cd80dd73e9a2f33704fc')
            api_url_dingding_hzp = "https://oapi.dingtalk.com/robot/send?timestamp=%s&access_token=%s" % (
            str(round(time.time() * 1000)), '4fa42dfced14210f79fde669863f72de96ef969ef74cc2de0f52d08bf845136a')
            ...
            requests.post(api_url_dingding_hzp, data=d, headers=headers).content
